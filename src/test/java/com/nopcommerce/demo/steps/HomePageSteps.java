...
public class HomePageSteps {
    ...
    public void computersTextDisplayed() {
        ...
        org.junit.Assert.assertEquals("Computers text is not displayed", expectedText, new TopMenuPage().getVerifyComputer());
    }
    ...
    public void electronicsTextDisplayed() {
        org.junit.Assert.assertEquals("Electronics is not displayed", "Electronics", new TopMenuPage().getVerifyElectronics());
    }
